...
public class ArticleStemCountVectorBuilderTest {
	...
	public void testRetrieveArticleStemCount() throws ParseException {
		...
		List<ArticleStemCount> list = (new ArticleStemCountVectorBuilder()).retrieveArticleStemCount(1, minDate);
	...
	public void testBuildArticleStemCountVectorMap() throws ParseException {
		...
		Map<Article, SparseVector> map = (new ArticleStemCountVectorBuilder()).buildArticleStemCountVectorMap(1, minDate, 1);
